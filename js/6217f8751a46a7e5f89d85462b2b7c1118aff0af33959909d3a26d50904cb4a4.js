! function(t) {
    ...
    class i {
        ...
        runOnResize(t, e) {
            ...
            }), this.items.sort(((t, e) => t.options.priority - e.options.priority)), e.runOnLoad && function(t, e = Number.MAX_VALUE) {
                var i;
                (window.canva_scriptExecutor = null !== (i = window.canva_scriptExecutor) && void 0 !== i ? i : new n).runOnLoad({
                    callback: t,
                    priority: e
                })
            }(t, e.priority)
    ...
    const o = "data-aspect-ratio",
        r = "scale_rotated_fill_v2",
        s = "--scale-fill";
    ...
    function c(t) {
        ...
        const {
            width: n,
            height: i
        } = t.parentElement.getBoundingClientRect(), r = i / n / parseFloat(e);
        t.style.setProperty(s, `${r}`)
    }(function(t, n, o = e) {
        var r;
        (window.canva_debounceResize = null !== (r = window.canva_debounceResize) && void 0 !== r ? r : new i(o)).runOnResize(t, {
            runOnLoad: !1,
            runOnWidthChange: !0,
            runOnHeightChange: !1,
        ...
        Array.from(document.querySelectorAll(`.${r}`)).forEach(c)
    }), {
        runOnLoad: !0,
        runOnHeightChange: !0
    }), t.scaleRotatedFill = c, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}({});
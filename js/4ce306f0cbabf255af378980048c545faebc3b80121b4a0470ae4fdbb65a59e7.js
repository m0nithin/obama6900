! function() {
    ...
    function B(e, t, r) {
        ...
        if (!i) throw new s("Could not create shader");
    ...
    class $ {
        constructor(e) {
            this.index = 0, this.buffers = null != e ? e : [new y({
                colorFormat: "rgba",
                numberFormat: "u8"
            }), new y({
                colorFormat: "rgba",
    ...
    const ie = "data-modifiers",
        ...
        se = (e, t) => {
            var r;
            const a = (e => e.getAttribute(ne))(e),
                i = (e => {
                    const t = e.getAttribute(ie);
                    return null != t && t.split(",").includes("STACKED_ALPHA_MASK")
                })(e);
            if (!i && !a) return;
            const n = oe.supportsImageBitmapRendering() ? t.getContext("bitmaprenderer") : t.getContext("2d");
            if (null == n) return;
                ...
                e.readyState >= 2 && ((() => {
                    ...
                    const {
                        ...
                        const t = e.clientWidth,
                            ...
                            s = o / a;
                        return {
                            videoWidth: s > 1 ? r * o : t,
                            videoHeight: s > 1 ? r : t / o
                        }
                    })(e), l = oe.render({
                        source: s,
                        backgroundRemoved: i,
                        ...
                        return {
                            sx: (e.width - a) * o.x / 100,
                            sy: (e.height - i) * o.y / 100,
                            width: a,
                            height: i
                        }
                    })(l, e, o);
                    oe.supportsImageBitmapRendering() && n instanceof ImageBitmapRenderingContext ? createImageBitmap(l, h, d, f, g).then((e => {
                        t.width = f, t.height = g, t.style.transform = r, n.transferFromImageBitmap(e)
                    })) : n instanceof CanvasRenderingContext2D && (t.width = f, t.height = g, t.style.transform = r, n.clearRect(0, 0, f, g), n.drawImage(l, h, d, f, g))
            ...
            e.addEventListener("pause", (() => {
                ...
                o = requestAnimationFrame(s)
            })), e.paused || (o = o || requestAnimationFrame(s))
        },
        ce = new Map;
    r((() => {
        document.querySelectorAll(`video[${ie}], video[${ne}]`).forEach((e => ce.set(e, (() => {

! function() {
    ...
    class s {
        constructor() {
            this.menuButton = document.getElementById("menuButton"), this.horizontalMenu = document.getElementById("horizontalMenu"), this.verticalMenu = document.getElementById("verticalMenu"), this.menuToggle = document.getElementById("menuToggle"), this.horizontalMenuWidth = this.horizontalMenu.clientWidth
        }
        exists() {
    ...
    n((() => {
        const t = new s;
        t.exists() && (window.addEventListener("hashchange", (() => {
            t.menuToggle.checked = !1
        })), o((() => function(t) {
            const e = document.body.clientWidth;
            t.horizontalMenuWidth > e ? t.showHamburgerMenu() : t.showHorizontalMenu()
        }(t)), {
            runOnLoad: !0
        }))
    }))
